...
- In this project, I build Developer Landing Page.

- I learned, position property.

- I learned, box-shadow property.

- I learned, how to place button inside the input box.

- I learned, how to add links and images in footer.


***

### Checkout the webiste : [Click Here](https://the-developer-page.netlify.app/)
